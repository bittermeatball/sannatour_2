...
if ( $nd_travel_meta_box_price == '' ) { 
    ...
    if ( $nd_travel_meta_box_promotion_price != '' ) { 
        $nd_travel_price_ribbon_sale = '<a class="nd_travel_width_200 nd_travel_text_align_center nd_travel_transform_rotate_45_negative nd_travel_position_absolute nd_travel_top_15 nd_travel_left_70_negative nd_travel_bg_greydark nd_options_color_white " href="'.$nd_travel_permalink.'">'.__('ƯU ĐÃI','nd-travel').'</a>';
    }else{ 
        $nd_travel_price_ribbon_sale = '';
    }
}

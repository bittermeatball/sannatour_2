...
{  
  ...
  $nd_travel_labels = $atts['nd_travel_labels'];
  ...
  if ( $nd_travel_labels == '' ) { $nd_travel_labels = 'not'; }

  //icons for layout 3
  $nd_travel_image_1_src = wp_get_attachment_image_src($atts['nd_travel_image_1'],'large');
  $nd_travel_image_2_src = wp_get_attachment_image_src($atts['nd_travel_image_2'],'large');
  $nd_travel_image_3_src = wp_get_attachment_image_src($atts['nd_travel_image_3'],'large');
      ...
      "params" => array(
          ...
          array(
           ...
           array(
            ...
            'dependency' => array( 'element' => 'nd_travel_layout', 'value' => 'layout-1' )
         ),
          array(
            'type' => 'dropdown',
            ...
            'dependency' => array( 'element' => 'nd_travel_layout', 'value' => array( 'layout-1','layout-3' ) )
         ),
          array(
            "type" => "textfield",
            "class" => "",
           ...
           array(
            'type' => 'dropdown',
            "heading" => __( "Show Labels", "nd-travel" ),
            'param_name' => 'nd_travel_labels',
            'value' => array( __( 'Select', 'nd-travel' ) => ' ', __( 'Not', 'nd-travel' ) => 'not', __( 'Yes', 'nd-travel' ) => 'yes'),
            'description' => __( "Select if you want to show the labels", "nd-travel" ),
            'dependency' => array( 'element' => 'nd_travel_layout', 'value' => 'layout-1' )
         ),
          array(
            "type" => "colorpicker",
         ...
         'type' => 'dropdown',
          ...
          'description' => __( "Select if you want to remove some fields", "nd-travel" ),
            'dependency' => array( 'element' => 'nd_travel_layout', 'value' => array( 'layout-1' ) )
         ),
        array(
          'type' => 'checkbox',
        ...
        array(
            'type' => 'attach_image',
            'heading' => __( 'Icon for keyword field', 'nd-travel' ),
            'param_name' => 'nd_travel_image_1',
            'description' => __( 'Select image from media library.', 'nd-travel' ),
            'dependency' => array( 'element' => 'nd_travel_layout', 'value' => 'layout-3' )
         ),
        array(
            'type' => 'attach_image',
            'heading' => __( 'Icon for destination field', 'nd-travel' ),
            'param_name' => 'nd_travel_image_2',
            'description' => __( 'Select image from media library.', 'nd-travel' ),
            'dependency' => array( 'element' => 'nd_travel_layout', 'value' => 'layout-3' )
         ),
        array(
            'type' => 'attach_image',
            'heading' => __( 'Icon for typology field', 'nd-travel' ),
            'param_name' => 'nd_travel_image_3',
            'description' => __( 'Select image from media library.', 'nd-travel' ),
            'dependency' => array( 'element' => 'nd_travel_layout', 'value' => 'layout-3' )
         ),
         array(
...
function nd_travel_build_select($nd_travel_tax,$nd_travel_i,$nd_travel_width,$nd_travel_fields_padding,$nd_travel_field_class,$nd_travel_labels){ 
  ...
  if ( $nd_travel_labels == 'yes' ){
    $nd_travel_select .= '
      <h6 class="nd_travel_letter_spacing_1">'.$nd_travel_tax_name.'</h6>

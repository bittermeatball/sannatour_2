      ...
      <div class="nd_travel_id_metabox_cpt_content">
        ...
        <div id="nd_travel_tab_preview">
          ...
          <div class="nd_travel_section nd_travel_border_bottom_1_solid_eee nd_travel_padding_10 nd_travel_box_sizing_border_box">
            ...
            <p><input class="nd_travel_width_100_percentage" type="text" name="nd_travel_meta_box_icon_cpt_3" id="nd_travel_meta_box_icon_cpt_3" value="<?php echo $nd_travel_meta_box_icon_cpt_3 ?>" /></p>
            <input class="button nd_travel_meta_box_icon_cpt_3_button" type="button" name="nd_travel_meta_box_icon_cpt_3_button" id="nd_travel_meta_box_icon_cpt_3_button" value="<?php _e('Upload','nd-travel'); ?>" />
            <p><?php _e('Insert the icon','nd-travel'); ?></p>
            ...
            <script type="text/javascript">
              ...
              jQuery(document).ready(function() {
                ...
                jQuery( function ( $ ) {
                  ...
                  var file_frame = [],
                  $button = $( '.nd_travel_meta_box_icon_cpt_3_button' );


                  $('#nd_travel_meta_box_icon_cpt_3_button').click( function () {
                    ...
                    file_frame[ id ].on( 'select', function() {
                      ...
                      $('#nd_travel_meta_box_icon_cpt_3').val(attachment.url);
          ...
          <div class="nd_travel_section nd_travel_padding_10 nd_travel_box_sizing_border_box">
              ...
              <p>
                  ...
                  <select class="nd_travel_width_100_percentage" name="nd_travel_meta_box_page_layout_cpt_3" id="nd_travel_meta_box_page_layout_cpt_3">
                      ...
                      <option <?php if( $nd_travel_meta_box_page_layout_cpt_3 == 'layout-2' ) { echo 'selected="selected"'; } ?> value="layout-2"><?php _e('Layout 2','nd-travel'); ?></option>
...
function nd_travel_meta_box_save_cpt_3( $post_id )
{
    ...
    if( isset( $_POST['nd_travel_meta_box_icon_cpt_3'] ) ) update_post_meta( $post_id, 'nd_travel_meta_box_icon_cpt_3', wp_kses( $_POST['nd_travel_meta_box_icon_cpt_3'], $allowed ) );

...
<!--max night range-->
<div id="nd_travel_search_cpt_1_form_night_range" class="nd_travel_width_33_percentage nd_travel_width_100_percentage_responsive nd_travel_padding_15 nd_travel_float_left nd_travel_box_sizing_border_box">
  ...
  <div class="nd_travel_section nd_travel_box_sizing_border_box">
    ...
    <div class="nd_travel_section">
      <h5 class="nd_travel_float_left ">'.__('Max Price','nd-travel').' :</h5> 
      '.$nd_travel_currency_right_value.'
    ...
    <p class="nd_travel_width_100_percentage nd_travel_width_100_percentage_all_iphone nd_travel_float_left nd_travel_margin_0">
      ...
      '.__('CHỈ HIỆN TOURS VỚI ƯU ĐÃI','nd-travel').'
...
<style>
    ...
    #nd_travel_slider_range .ui-slider-range {
      background-color:'.$nd_travel_shortcode_search_results['slider_price_color'].';
    }

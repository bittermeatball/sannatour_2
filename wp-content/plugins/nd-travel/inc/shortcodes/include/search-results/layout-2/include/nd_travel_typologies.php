...
<!--START typologyes-->
		<div id="nd_travel_search_l2_typologies" class=" '.$nd_travel_typologies_class.' nd_travel_width_25_percentage nd_travel_width_100_percentage_responsive nd_travel_padding_10 nd_travel_float_left nd_travel_box_sizing_border_box">
			...
			<div class="nd_travel_section nd_travel_position_relative nd_travel_box_sizing_border_box">
		        ...
		        <div class="nd_travel_section">
		            <h5 class="nd_travel_float_left ">'.__('Typologies','nd-travel').' :</h5> 

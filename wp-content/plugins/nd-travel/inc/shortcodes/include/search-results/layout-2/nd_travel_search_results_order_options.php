...
$nd_travel_shortcode_order_options .= '
  ...
  <script type="text/javascript">
    ...
    .nd_travel_search_filter_layout_grid { background-image:url('.plugins_url().'/nd-travel/assets/img/icons/travel/icon-menu-white-opacity.png); }
    .nd_travel_search_filter_layout_grid.nd_travel_search_filter_layout_active { background-image:url('.plugins_url().'/nd-travel/assets/img/icons/travel/icon-menu-white.png); }

    .nd_travel_search_filter_layout_list.nd_travel_search_filter_layout_active { background-image:url('.plugins_url().'/nd-travel/assets/img/icons/travel/icon-list-white.png); }
    .nd_travel_search_filter_layout_list { background-image:url('.plugins_url().'/nd-travel/assets/img/icons/travel/icon-list-white-opacity.png); }
                ...
                <div id="nd_travel_search_l2_order_options_1" class="nd_travel_width_33_percentage nd_travel_float_left">
                  ...
                  <ul id="nd_travel_search_filter_options" class="nd_travel_list_style_none nd_travel_display_inline_block nd_travel_padding_0 nd_travel_margin_0">
                    <li id="nd_travel_vc_order_price" class="nd_travel_display_inline_block nd_travel_position_relative nd_travel_padding_0 nd_travel_margin_right_30  nd_travel_margin_0 nd_travel_float_left">
                        ...
                        <img alt="" class="nd_travel_margin_left_10 nd_travel_margin_top_8 nd_travel_float_left" width="10" src="'.plugins_url().'/nd-travel/assets/img/icons/icon-down-arrow-white.svg">

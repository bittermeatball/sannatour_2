	...
	while(have_posts()) : the_post();
			...
			<div id="nd_travel_single_cpt_3_all_packages" class="nd_travel_width_100_percentage nd_travel_float_left">
				...
				<div class="nd_travel_section nd_travel_text_align_center">
				    <h3 class="nd_options_color_grey nd_travel_font_size_14 nd_travel_letter_spacing_2 nd_travel_font_weight_normal nd_travel_text_transform_uppercase">'.$nd_travel_destination_title.'</h3>
                ...
                <style>
                	#nd_travel_single_cpt_3_all_packages h1.nd_travel_font_size_35 u:after { background-color:'.$nd_travel_meta_box_cpt_3_color.'; position: absolute; content: ""; width: 100%; height: 5px; left: 0; bottom: 11px; z-index: -9; }
			    ...
			    '.do_shortcode('[nd_travel_packages_pg nd_travel_layout="layout-5" nd_travel_width="nd_travel_width_33_percentage nd_travel_float_left" nd_travel_destinations="'.$nd_travel_destination_id.'" nd_travel_image_size="large" nd_travel_qnt="-1"]').'
